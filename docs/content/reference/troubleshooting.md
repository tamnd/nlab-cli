...
Most of these come down to network reality or how nlab serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nlab rate-limits like any public site. nlab already paces
...
Where a surface is gated, nlab reads a cookie or token you supply
...
`nlab`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nlab actually did
